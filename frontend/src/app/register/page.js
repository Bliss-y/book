  ...
  return (
    <main className="flex min-h-screen flex-col items-center  h- bg-[#0f172a]">
      ...
      >
        ...
        <input className="text-slate-900 pl-2" type="text" name="fname" />
        <hr className=" w-full h-0.5 mt-2 text-white bg-white"></hr>
        <label>Last Name:</label>
        <input className="text-slate-900 pl-2" type="text" name="lname" />
        <hr className=" w-full h-0.5 mt-2 text-white bg-white"></hr>
        <label>Username:</label>
        <input className="text-slate-900 pl-2" type="text" name="username" />
        <hr className=" w-full h-0.5 mt-2 text-white bg-white"></hr>
        <label>email:</label>
        <input className="text-slate-900 pl-2" type="text" name="email" />
        <hr className=" w-full h-0.5 mt-2 text-white bg-white"></hr>
